...
default['riak']['config']['bitcask']['frag_merge_trigger'] = 40
default['riak']['config']['bitcask']['dead_bytes_merge_trigger'] = 134217728
default['riak']['config']['bitcask']['frag_threshold'] = 20
default['riak']['config']['bitcask']['dead_bytes_threshold'] = 67108864
